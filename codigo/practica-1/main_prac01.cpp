...
int main()
{
	...
	Model casaBrujas("resources/objects/brujas/CasaBurbujas.obj");
	//Model tapete("resources/objects/tapete/10404_Circular_Throw_Rug_v1_max2010_iterations-2.obj");
	Model chems("resources/objects/chems/chems.obj");
	...
	ModelAnim amy("resources/objects/Amy/Shoved_Reaction_With_Spin.dae");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//dibujar a,y
		model = glm::translate(glm::mat4(1.0), glm::vec3(100.0f,0.0f,20.f));
